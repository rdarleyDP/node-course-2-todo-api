...
describe('PATCH /todos/:id', () => {
    it('should update the todo', (done) => {
        var hexId = todos[0]._id.toHexString();
        var text = 'New todo text for testing';
    ...
    it('should not let user update todo that is not theirs', (done) => {
        var hexId = todos[0]._id.toHexString();
        var text = 'New todo text for testing';
...
describe('POST /users', () => {
    it('should create a user', (done) => {
        var email = 'izzy@example.com';
        var password = 'iLikeToSleep';
